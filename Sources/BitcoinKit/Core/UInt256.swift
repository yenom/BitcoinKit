...
struct UInt256 {
	...
	public static var bitWidth: Int { get { return 256 } }
...
extension UInt256 : Equatable {
	public static func == (lhs: UInt256, rhs: UInt256) -> Bool {
		if lhs.e0 != rhs.e0 { return false }
		else if lhs.e1 != rhs.e1 { return false }
		else if lhs.e2 != rhs.e2 { return false }
		else if lhs.e3 != rhs.e3 { return false }
		return true
	}
}
...
extension UInt256 : Comparable {
	public static func < (lhs: UInt256, rhs: UInt256) -> Bool {
		...
		else if lhs.e2 != rhs.e2 { return lhs.e2 < rhs.e2 }
		else if lhs.e1 != rhs.e1 { return lhs.e1 < rhs.e1 }
		else if lhs.e0 != rhs.e0 { return lhs.e0 < rhs.e0 }
...
fileprivate func bitValue(bit: UInt) -> UInt64 {
	var v:UInt64 = 0
	for i in 0 ..< bit {
		v += (1 << i)
	}
